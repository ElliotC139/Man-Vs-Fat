...
INSERT INTO "new_Entry" ("createdAt", "edited", "id", "imageUrl", "kcal", "label", "matchWeekId", "rawInput", "timestamp", "updatedAt") SELECT "createdAt", "edited", "id", "imageUrl", "kcal", "label", "matchWeekId", "rawInput", "timestamp", "updatedAt" FROM "Entry";
DROP TABLE "Entry";
